...
CREATE TABLE `farmer` (
  ...
  `picExt` varchar(255) NOT NULL DEFAULT 'png''jpg''jpeg',
...
(3, 'Agnes Licoyo', 'ThePhenom', '$2y$10$22ezmzHRa9c5ycHmVm5RpOnlT4LwFaDZar1XhmLRJQKGrcVRhPgti', '61b4a64be663682e8cb037d9719ad8cd', 'agneslicoyo@gmail.com', '8600611198', 'abcde', 0, 0, 'png''jpg''jpeg', 0);
...
CREATE TABLE `fproduct` (
  ...
  `pimage` varchar(255) NOT NULL DEFAULT 'png''jpg''jpeg',
  `picStatus` int(10) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(3, 27, 'Mango', 'Fruit', '<p></p>\r\n', 500, 'images/producImages/mango.JPG', 1),
(3, 28, 'Okra', 'Vegetable', '<p></p>\r\n', 1000, 'images/productImages/okra.JPG', 1),
(3, 29, 'Rice', 'Grains', '<p></p>\r\n', 400, 'images/productImages/rice.JPG', 1),
(3, 30, 'Banana', 'Fruit', '<p></p>\r\n', 400, 'images/productImages/banana.JPG', 1);
